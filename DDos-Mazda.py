...
def usage():
	print("Hammer запушен !")
	print (''' \033[92m	Hammer DDos Script v.2.5 
Ответственность за соблюдение всех применимых законов лежит на конечном пользователе.
 Это только для сценария тестирования сервера. Ваш ip-адрес виден. \северный
 использование: python3 hammer.py [- s] [- p] [- t]
 -h: помогите
 -s: IP сервера
